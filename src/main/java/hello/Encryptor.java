...
public class Encryptor {
	...
	public static boolean checkPass(String pass, String hash) {
		...
		if (pass.equals(decrypt(StatVar.key, StatVar.iv, hash))) {
			return true;
		} else {
			return false;
		}
	...
	/*
	 * public static void main(String[] args) { String key = "Bar12345Bar12345"; //
	 * 128 bit key String initVector = "RandomInitVector"; // 16 bytes IV
	 * 
