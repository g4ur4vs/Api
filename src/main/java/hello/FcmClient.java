 ...
 * Easy to send notification to entity(mobile devices,browser front-end
 * apps)s<br>
 * 
...
public class FcmClient {
	...
	/**
	 * 
	 * To send messages to specific entity(mobile devices,browser front-end apps)(s)
	 * specified by registration token(s) that can be retrieved by
	 ...
	 * Where is server API key. Open {@link https://console.firebase.google.com} and
	 * select your project.Click project settings and you can find the Server Key on
	 * the "CloudMessaging Tab"
	 * 
	 */
